...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/raspy-scene-a280)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/raspy-scene-a280
```

A live public deployment of this template is available at [https://raspy-scene-a280.templates.workers.dev](https://raspy-scene-a280.templates.workers.dev)
